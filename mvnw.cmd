...
@SET MVNW_USERNAME=
@SET MVNW_PASSWORD=
@REM Prefer a local JDK 21 for this project (Spring Boot 4 requires Java 21+)
@IF EXIST "C:\Program Files\Eclipse Adoptium" (
  @FOR /F "delims=" %%D IN ('dir /b /ad /o-n "C:\Program Files\Eclipse Adoptium\jdk-21*" 2^>nul') DO (
    ...
    @GOTO :__mvnw_java_home_ready
  )
)
@IF EXIST "C:\Program Files\Java" (
  @FOR /F "delims=" %%D IN ('dir /b /ad /o-n "C:\Program Files\Java\jdk-21*" 2^>nul') DO (
    @SET "JAVA_HOME=C:\Program Files\Java\%%D"
    @GOTO :__mvnw_java_home_ready
  )
)
:__mvnw_java_home_ready
